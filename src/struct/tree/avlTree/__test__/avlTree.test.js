...
describe("测试avlTree", () => {
  it("测试平衡", () => {
    let treeRightRight = new AvlTree()
    treeRightRight.insert(0)
    treeRightRight.insert(19)
    treeRightRight.insert(22)
    expect(treeRightRight.root.value).toBe(19)
    expect(treeRightRight.root.left.value).toBe(0)
    expect(treeRightRight.root.right.value).toBe(22)

    let treeRightLeft = new AvlTree()
    treeRightLeft.insert(0)
    treeRightLeft.insert(19)
    treeRightLeft.insert(10)
    expect(treeRightLeft.root.value).toBe(10)
    expect(treeRightLeft.root.left.value).toBe(0)
    expect(treeRightLeft.root.right.value).toBe(19)

    let treeLeftLeft = new AvlTree()
    treeLeftLeft.insert(0)
    treeLeftLeft.insert(-19)
    treeLeftLeft.insert(-22)
    expect(treeLeftLeft.root.value).toBe(-19)
    expect(treeLeftLeft.root.left.value).toBe(-22)
    expect(treeLeftLeft.root.right.value).toBe(0)

    let treeLeftRight = new AvlTree()
    treeLeftRight.insert(0)
    treeLeftRight.insert(-19)
    treeLeftRight.insert(-10)
    expect(treeLeftRight.root.value).toBe(-10)
    expect(treeLeftRight.root.left.value).toBe(-19)
    expect(treeLeftRight.root.right.value).toBe(0)
...
describe('AvlTree', () => {
  ...
  it('should remove values from the tree with right-right rotation', () => {
    ...
    expect(tree.root.heightDiff).toBe(0);
  });
  ...
  it('should keep balance after removal', () => {
    ...
    expect(tree.root.height).toBe(3);
    expect(tree.root.heightDiff).toBe(-1);
